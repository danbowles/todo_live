defmodule TodoLiveWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          ...
          <%!-- <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8"> --%>
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-8 shadow-lg transition"
            >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-purple-900 hover:bg-purple-700 py-2 px-3",
